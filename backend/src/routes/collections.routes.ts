    ...
    if (slug === 'all') {
      ...
      res.json({
        collection: {
          ...
          description: 'Browse our full catalog of high-performance lifestyle, audio, and tech gear.',
          image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=1200&q=80',
          seoTitle: 'All Products & Equipment | GumShop',
          seoDescription: 'Explore our complete collection of curated physical products and lifestyle essentials.',
